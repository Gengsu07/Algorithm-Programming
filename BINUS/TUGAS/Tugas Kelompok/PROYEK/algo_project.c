...
void check_connection(const char filename[]);
size_t countRecords(FILE *db_session);
int status = SUCCESS;

FILE *dbsession_buku;
FILE *dbsession_transaksi;
char databuku[] = "databuku.txt";
char datatransaksi[] = "datatransaksi.txt";
char *msg_notif = NULL;
char msg_buffer[100];

// main program loop yang akan menuju menu sesuai yg dipilih
int main(void)
{
    int navmenu = 0;
...
// Module menambahkan Buku ke dalam database
void addBook(void)
{
...
// Module Menambahkan Transaksi Penjualan ke dalam database Transaksi
void createTransaction(void)
{
...
// Module untuk melihat history transaksi penjualan
void salesHistory(void)
{
...
// Module untuk melihat data buku
void viewBook(void)
{
    Book *getHistory = NULL;
    dbsession_buku = fopen(databuku, "a+");
...
// Module untuk menghapus data buku
void deleteBook(void)
{
    Book *getHistory = NULL;
    dbsession_buku = fopen(databuku, "r+");
...
// Module untuk menghapus data transaksi penjualan
void deleteSalesHistory(void)
{
    Transaksi *getHistory = NULL;
...
// Module untuk menghitung jumlah data dalam file
size_t countRecords(FILE *dbcount)
{
    size_t counter = 0;
    char buffer[256];
    // set pointer di awal file
    fseek(dbcount, 0, SEEK_SET);
...
// Module untuk menampilkan pesan notifikasi
void setMsgNotif(const char *msg)
{
...
// Module untuk menampilkan pesan error saat gagal alokasi memori
void memoryFailed(void)
{
...
// Module untuk menampilkan pesan error saat gagal membuka file
void check_connection(const char filename[])
{
